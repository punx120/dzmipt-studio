...
public class QTokenContext extends TokenContext
{
    ...
    public static final int ML_COMMENT_ID  = 6;
    public static final int KEYWORD_ID     = 7;
    public static final int WHITESPACE_ID  = 8;
    public static final int UNKNOWN_ID     = 9;
    public static final int INTEGER_ID     = 10;
    public static final int BRACKET_ID     = 11;
    public static final int MINUTE_ID      = 12;
    public static final int SECOND_ID      = 13;
    public static final int TIME_ID        = 14;
    public static final int DATE_ID        = 15;
    public static final int MONTH_ID       = 16;
    public static final int FLOAT_ID       = 17;
    public static final int LONG_ID        = 18;
    public static final int SHORT_ID       = 19;
    public static final int REAL_ID        = 20;
    public static final int BYTE_ID        = 21;
    public static final int BOOLEAN_ID     = 22;
    public static final int DATETIME_ID    = 23;
    public static final int COMMAND_ID     = 24;
    public static final int SYSTEM_ID      = 25;
    public static final int TIMESTAMP_ID   = 26;
    public static final int TIMESPAN_ID    = 27;
   ...
   // public static final BaseTokenID CHARVECTOR= new BaseTokenID("charvector", CHARVECTOR_ID);
    ...
    public static final BaseTokenID ML_COMMENT = new BaseTokenID("mlComment", ML_COMMENT_ID);
    public static final BaseTokenID KEYWORD=     new BaseTokenID("keyword",    KEYWORD_ID);
