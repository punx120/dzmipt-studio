...
public class Config {
    ...
    private static final String WORKSPACE = PATH + "workspace.properties";
    ...
    public Workspace loadWorkspace() {
        ...
        try {
            ...
            InputStream inp = new FileInputStream(WORKSPACE);
            p.load(inp);
            inp.close();
            workspace.load(p);
        } catch (IOException e) {
    ...
    public void saveWorkspace(Workspace workspace) {
        try {
            Properties p = new Properties();
            workspace.save(p);
            OutputStream out = new FileOutputStream(WORKSPACE);
